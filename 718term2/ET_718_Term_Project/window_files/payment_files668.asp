...
<%
	...
	Mailer.Subject = "Re: Online Order"
      Mailer.FromAddress = Request.form("email")
      Mailer.AddRecipient Request.form("namn"), Request.form("email")
	Mailer.AddCC "", "" & receipt & ""
	Mailer.BodyText = "Credit Card Payment - Order Number = "&RandNo()& vbcrlf & vbcrlf&_ 
...
<IMG SRC="images/paypal.gif" WIDTH="117" HEIGHT="32" ALT="PayPal">
</DIV><P>
</FONT>
...
<INPUT TYPE="hidden" NAME="item_name" VALUE="Payment for Order Number <% = Request.form("order_id") %>">
