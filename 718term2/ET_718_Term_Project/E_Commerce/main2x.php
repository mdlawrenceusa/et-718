  ...
  <div class="inner-wrap">
    ...
    <aside class="left-off-canvas-menu">
      <ul class="off-canvas-list">
        <li><label>Magical Categories</label></li>
        <?php
...
while($row = mysql_fetch_row($result)) {
	...
	echo "<li><lable><a href='#' class='Menu' onClick='javascript: Menu($i);'><B>$row[0]</B></a></label></li>";
...
while($row = mysql_fetch_row($result2)) {
	...
	echo "<li><a href=\"item_list2.php?maingroup=$row[0]&secondgroup=$row[1]\" target=\"main\">$row[1]</a></li>";
...
?>
    ...
    <aside class="right-off-canvas-menu">
      <ul class="off-canvas-list">
        ...
        <li><a href="terms.php" target="main"><?php echo $txt_terms ?></a></li>
		<li><a href="contact.php" target="main"><?php echo $txt_contact ?></a></li>
      </ul>
    </aside>
