...
<TR><TD VALIGN=top>
<A HREF="order_money.php"><IMG SRC="images/money.gif" BORDER="0" WIDTH="72" HEIGHT="55" ALT="Money Order"></A>
</TD>
<TD VALIGN=top WIDTH="400" NOWRAP>
<font size="1" face="Verdana, Arial, Helvetica, sans-serif"><B><A HREF="order_money.php"><?php echo $txt_invoice_payment ?></A></B><BR>
...
<B><A HREF="order_card.php"><?php echo $txt_credit_card_payment  ?></A></B> <BR>
