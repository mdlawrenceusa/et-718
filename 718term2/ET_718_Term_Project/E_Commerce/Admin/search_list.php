...
<TR>
<TD BGCOLOR="#B3B3B3"><B><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><?php echo $txt_maingroup ?></font></B></TD>
...
$result = mysql_query("select * from mlawrence_products WHERE $chose LIKE '%$searchstring%' ORDER BY 'maingroup', 'secondgroup', 'code_no'") ;
...
while($row = mysql_fetch_row($result)) {
	...
	echo "<TR  BGCOLOR=\"#$color\"><TD><font size=\"1\" face=\"Verdana, Arial, Helvetica, sans-serif\"><a href=\"category_list.php?maingroup=$row[0]\" TARGET=\"main\">$row[0]</FONT></TD>";
	echo "<TD><font size=\"1\" face=\"Verdana, Arial, Helvetica, sans-serif\"><a href=\"item_list.php?maingroup=$row[0]&secondgroup=$row[1]\" TARGET=\"main\">$row[1]</FONT></TD>";
