...
<?php echo $maingroup ?> / <?php echo $secondgroup ?></FONT>
...
while($row = mysql_fetch_row($result)) {
	...
	echo "<TR BGCOLOR=\"#$color\"><TD><font size=\"1\" face=\"Verdana, Arial, Helvetica, sans-serif\"><a href=\"item_show.php?code_no=$row[2]\" TARGET=\"main\">$row[2]</FONT></TD>";
